...
class __Mustache_58d8f284dc6d6f20617e5071800fbe06 extends Mustache_Template
{
...
';
        ...
        $buffer .= '</label>
';
        $buffer .= $indent . '        <select id="visitsonsite-student-select" class="form-control singleselect w-full" name="state">
';
